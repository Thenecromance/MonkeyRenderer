...
#include <flecs.h>
// if using Experimental's modules just need to becareful to use PreFrame and
// ImGuiRender just because the GLADModule and GLFWModule will be loaded in
// PreFrame and running in the ImGuiRender
...
static const flecs::entity_t LightBinding          = flecs ::PostLoad;  // In this phase should only be has CameraUpdate
static const flecs::entity_t CameraUpdate            = flecs::PreUpdate;  // Binding lights and update lights
